...
use super::{ComponentSource, LoadRejection, LoadTransition, LoaderError};
use crate::system::{AddonId, ComponentDefinition, ComponentInstanceId};
...
impl LoadRecord {
    ...
    #[must_use]
    pub(crate) fn declared(request: &super::LoadRequest) -> Self {
        Self {
            id: request.id(),
