//! Private affected-subgraph activation planning.

use std::collections::{BTreeMap, BTreeSet};

use super::{
    Binding, BindingCandidate, BindingHook, BindingProposal, Requirement,
    policy::evaluate_binding_hooks,
};
use crate::{
    execution::{ExecutionFront, ExecutionPlan, ExecutionWork},
    runtime::KernelError,
    system::{
        CapabilityContractId, ComponentInstanceId, ComponentRuntime, ComponentRuntimeId,
        GraphState, ResolutionState,
    },
};
...
pub struct ActivationPlan {
    ...
    pub(crate) instance_id: ComponentInstanceId,
...
impl GraphState {
    ...
    pub(crate) fn affected_activation_plan(
        &self,
    ...
    pub(crate) fn apply_activation(
        ...
        let mailbox_policy = self
            ...
            .map_or_else(crate::routing::MailboxPolicy::default, |definition| {
