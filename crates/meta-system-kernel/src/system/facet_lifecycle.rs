...
use super::{Context, ContextOwner, Facet, FacetSchema, FacetTarget};
...
impl GraphState {
    ...
    pub(crate) fn register_context(&mut self, context: Context) -> Result<(), KernelError> {
    ...
    pub(crate) fn register_facet_schema(&mut self, schema: FacetSchema) -> Result<(), KernelError> {
    ...
    pub(crate) fn attach_facet(&mut self, facet: Facet) -> Result<(), KernelError> {
